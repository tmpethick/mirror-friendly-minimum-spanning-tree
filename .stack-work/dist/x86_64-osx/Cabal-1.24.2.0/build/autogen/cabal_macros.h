...
/* package hard-project-0.1.0.0 */
#define VERSION_hard_project "0.1.0.0"
#define MIN_VERSION_hard_project(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "hard-project-0.1.0.0-JiLdRhV0AFMB55kjwkqqqB"

#define CURRENT_PACKAGE_KEY "hard-project-0.1.0.0-JiLdRhV0AFMB55kjwkqqqB"
